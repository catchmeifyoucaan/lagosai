    ...
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className={`${theme.card} rounded-xl shadow-2xl w-full max-w-2xl`} onClick={e=>e.stopPropagation()}>
        ...
        <div className="p-6 space-y-3">
          ...
          <button disabled className="w-full px-4 py-3 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200">Continue with Apple (coming soon)</button>
